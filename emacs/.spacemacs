...
This function should only modify configuration layer settings."
  ...
  ;; A list of packages that cannot be updated.
   ...
   dotspacemacs-excluded-packages '(evil-lisp-state yasnippet auto-yasnippet yasnippet-snippets)
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-scratch-mode 'adoc-mode
...
(custom-set-faces
 ...
 '(markup-title-0-face ((t (:height 2.0))))
 '(markup-title-1-face ((t (:height 1.5))))
 '(markup-title-2-face ((t (:height 1.3))))
 '(markup-title-3-face ((t (:weight bold :height 1.2))))
 '(markup-title-5-face ((t (:underline t :height 1.1)))))
)
